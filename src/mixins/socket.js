...
import { SOCKET, WIDE_SEARCH, userInfo as WD } from '../lib/config';
...
module.exports = {
  data(){
    return {
      ...
      gwgo_token: this.$cookies.get("gwgo_token")
    };
  },
  methods: {
    /**
     ...
     * @param {*}} type
     * @param {*} options
     *  {"expires":7200,"gwgo_tk":"8619238982067585024","openid":"oxARK5LSgmAnpUL5NSn3hA7cBegw"}
     */
